...
export default class Picture extends React.Component {
  ...
  static propTypes= {
    ...
    maxRange : React.PropTypes.string.isRequired,
    minRange : React.PropTypes.string.isRequired,
    minZoom : React.PropTypes.string.isRequired,
    maxZoom : React.PropTypes.string.isRequired,
